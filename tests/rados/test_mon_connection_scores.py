...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        mon_obj.set_config(section="osd", name="debug_ms", value="1")
        mon_obj.set_config(section="osd", name="debug_monc", value="20/20")
        mon_obj.set_config(section="osd", name="debug_auth", value="20/20")
        ...
        mon_obj.remove_config(section="osd", name="debug_auth")
        mon_obj.remove_config(section="osd", name="debug_monc")
        mon_obj.remove_config(section="osd", name="debug_ms")
