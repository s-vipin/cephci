...
includes:
 ...
 Scenario 3 -> [stretch mode] Netsplit between mon1 of DC1 and mon2 of DC2 , mon1 of DC1 and mon3 of DC2
...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if "scenario3" in scenarios_to_run:
            log.info(
                "Scenario 3 -> Netsplit in stretch mode between mon1 of DC1 and mon2 of DC2. \n"
                "mon1 of DC1 and mon3 of DC2"
            )
            group_1_hosts = list()
            group_2_hosts = list()
