...
1. revert from health stretch mode to custom crush rule
2. revert from site down stretch mode to default crush rule
2. revert from site down stretch mode to custome crush rule
3. revert from netsplit scenario to default/non-default crush rule
3. revert from netsplit scenario to custom crush rule
"""
...
from test_stretch_revert_class import StretchMode
...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if "revert_stretch_mode_scenarios" in locals() and "revert_stretch_mode_scenarios" in globals():
...
class RevertStretchModeScenarios(RevertStretchModeFunctionalities):
    """
    Class includes test scenarios of revert stretch mode
    Scenario 1:- revert from health stretch mode to default/non-default crush rule
    Scenario 2:- revert from health stretch mode to custom crush rule
    Scenario 2:- revert from site down stretch mode to default crush rule
    Scenario 2:- revert from site down stretch mode to custome crush rule
    Scenario 2:- revert from netsplit scenario to default/non-default crush rule
    Scenario 2:- revert from netsplit scenario to custom crush rule
